                ...
                if data is None or weather_conditions is None:
                    ...
                    if sky in weather_conditions:
                        ...
                        if "error" in recommended_song:
                            ...
                            st.markdown(f"[Listen to this song on Spotify]({spotify_url})") st.markdown('<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Spotify_icon.svg/232px-Spotify_icon.svg.png" width=20>')
                            # st.markdown()
